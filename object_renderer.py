...
class ObjectRenderer:
    ...
    def render_game_objects(self):
        # no - list_objects = self.game.raycasting.objects_to_render -- seradi objekty podle poradi viditelnosti = sortted
    ...
    def load_wall_textures(self):
        return {
            ...
            14: self.get_texture('resources/textures/20.png'),
            15: self.get_texture('resources/textures/21.png'),
            16: self.get_texture('resources/textures/22.png'),
        }